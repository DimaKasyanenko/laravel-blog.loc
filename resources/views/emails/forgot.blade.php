            ...
            <table role="presentation"
                ...
                <tr style="border-collapse:collapse;border:1px solid #cccccc;border-spacing:0;">
                    <td align="left" style="padding:10px 25px;background:#fff; display: flex; align-items: center;">
                        <span style="font-weight: bold; padding-top: 10px;"> Laravel Blog </span>
                    </td>
                </tr>
                <tr>
                            ...
                            <tr>
                                <td style="padding:0 0 36px 0;color:#153643;">
                                    ...
                                    <p
                                        ...
                                        Вы можете изменить свой пароль, нажав на кнопку ниже:
                                    </p>

                                    <p style="text-align: center;">
                                        <a href="{{'http://localhost:8000/forgot-password/'.$token}}" class="">СБРОСИТЬ ПАРОЛЬ</a>
                                    </p>
